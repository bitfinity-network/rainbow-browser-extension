...
export type Erc20MintStatus =
  ...
  | {
      Scheduled: {
        ...
        pending_utxos: [] | [Array<any>];
        current_confirmations: number;
      };
    }
  | { Signed: Uint8Array | number[] };
export type EvmLink = { Ic: Principal } | { Http: string };
...
export type Result = { Ok: Erc20MintStatus } | { Err: DepositError };
export type Result_1 = { Ok: string } | { Err: GetAddressError };
